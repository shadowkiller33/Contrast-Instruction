...
def build_dataset(tokenizer, config):
    ...
    def tokenize(sample):
        tokenized_pos = tokenizer("Summarize the paragraph: " + sample['question'] + "\n\nAnswer: " + sample['response_j'], truncation=True)
        tokenized_neg = tokenizer("Summarize the paragraph: " + sample['question'] + "\n\nAnswer: " + sample['response_k'], truncation=True)
...
## Save model
model_lora.save_pretrained('/apdcephfs_cq2/share_1603164/data/lingfengshen/trl/sum_reward')