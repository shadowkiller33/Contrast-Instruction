...
def get_args():
    ...
    parser.add_argument("--output_dir", type=str, default="/apdcephfs_cq2/share_1603164/data/lingfengshen/output/checkpoints")
...
def run_training(args, train_data, val_data):
    ...
    model = AutoModelForCausalLM.from_pretrained(
        args.model_path#, load_in_8bit=False
    )
...
def main(args):
    ...
    architecture = config.architectures[0]#"GPT2LMHeadModel"#
