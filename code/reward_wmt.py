...
def preprocess_function(examples):
    ...
    for question, response_j, response_k in zip(examples["question"], examples["response_j"], examples["response_k"]):
        tokenized_j = tokenizer("Translate the following sentence to English: " + question + "\n\nAnswer: " + response_j, truncation=True)
        tokenized_k = tokenizer("Translate the following sentence to English: " + question + "\n\nAnswer: " + response_k, truncation=True)
...
model.save_pretrained("/apdcephfs_cq2/share_1603164/data/lingfengshen/trl/mt_reward")