...
eval_dataset = load_dataset('json', data_files="/apdcephfs_cq2/share_1603164/data/lingfengshen/trl/para_241_retrieval_0.8.json", split='train')
...
def preprocess_function(examples):
    ...
    for query,retrieval, response_j, response_k in zip(examples["query"], examples["retrieval"], examples["query_response_k"], examples["retrieval_response_k"]):
        ...
        tokenized_k = tokenizer("Paraphrase the following sentence: " + retrieval + "\n\nAnswer: " + response_j, truncation=True)
