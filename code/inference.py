...
eval_dataset = load_dataset('json', data_files="/apdcephfs_cq2/share_1603164/data/lingfengshen/trl/stack_652_retrieval_0.88.json", split='train')
...
def preprocess_function(examples):
    ...
    for query,retrieval, response_j, response_k in zip(examples["query"], examples["retrieval"], examples["query_response_k"], examples["retrieval_response_k"]):
        ...
        tokenized_j = tokenizer("Question: " + query + "\n\nAnswer: " + response_j, truncation=True)
        tokenized_k = tokenizer("Question: " + retrieval + "\n\nAnswer: " + response_j, truncation=True)
