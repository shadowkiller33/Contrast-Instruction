...
train_dataset = load_dataset("/apdcephfs_cq2/share_1603164/data/lingfengshen/data/stack-exchange-paired", data_dir="data/reward", split="train")
...
model.save_pretrained('/apdcephfs_cq2/share_1603164/data/lingfengshen/output/wmt'+output_name + "_peft_last_checkpoint")