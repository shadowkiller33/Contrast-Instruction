...
eval_dataset = load_dataset('json', data_files="/apdcephfs_cq2/share_1603164/data/lingfengshen/trl/sum_51_retrieval_0.75.json", split='train')
...
model = AutoModelForSequenceClassification.from_pretrained(
    '/apdcephfs_cq2/share_1603164/data/lingfengshen/trl/sum-rm',
...
def preprocess_function(examples):
    ...
    for query,retrieval, response_j, response_k in zip(examples["query"], examples["retrieval"], examples["query_response_k"], examples["retrieval_response_k"]):
        ...
        tokenized_j = tokenizer("Summarize the paragraph: " + query + "\n\nAnswer: " + response_j, truncation=True)
        tokenized_k = tokenizer("Summarize the paragraph: " + retrieval + "\n\nAnswer: " + response_j, truncation=True)
